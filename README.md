...
BS Computer Science student at the University of Central Punjab (UCP), 2024 - present.

This repository has the projects and lab work I've done for my courses.
All of it is working code. I mostly use C++ and also work with SQL and Assembly.

## Skills
- C++ (PF, OOP, Data Structures)
- SQL (database design and queries, functional dependencies and normalization)
- Assembly language

## Courses completed
Introduction to Computing, Programming Fundamentals, Object-Oriented
Programming, Data Structures, Database Management Systems (DBMS),
Computer Organization and Assembly Language (COAL)

## How I work
I use AI tools like ChatGPT to get ideas and understand concepts.
