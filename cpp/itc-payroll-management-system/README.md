...
A menu-based program that manages employee payroll records. 
It stores the data in arrays and calculates each employee's gross salary, tax and net salary automatically.
